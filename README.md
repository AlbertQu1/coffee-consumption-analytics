...
ML cup count prediction displayed alongside day estimate (e.g., "~42 tazas ±2.9")
Confidence interval displayed alongside point estimate
Zero-inventory alert triggered when no active or waiting bags are detected
